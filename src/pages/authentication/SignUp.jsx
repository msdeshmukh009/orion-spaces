const SignUp = () => {
  return (
    <main className="h-screen  flex justify-center text-text-color bg-background-color">
      <div className="w-[25rem] m-auto bg-secondary-color-50 p-4 rounded-md shadow-md shadow-secondary-color-100">
